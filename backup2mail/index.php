...
****************************************************/
	$db_server			= 'localhost';				// Database server, usually "localhost", 
 	...
 	$db_name 			= 'xlionnet_quran';				// Database name, leave empty for 'all databases'
	$db_user 		    = 'xlionnet_omae';				// Database username
	$db_pass 		    = 'A&cFo4A%7=[2';				// Database password
...
/***************************************************
	E-mail settings
****************************************************/
 	$website            = 'xlion.org';		    // Your site's domain (without www. part)
	$send_to 		    = 'larhnimikit@gmail.com';		        // backup file will be sent to?
	$from 		        = 'admin@' . $website;	// some hosting providers won’t let you send backups from invalid e-mail address
